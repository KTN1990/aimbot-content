function Tags() {
    (function(){
        var tagify = new Tagify(document.querySelector('input[name=white-countries]'), {
            delimiters : null,
            templates  : {
    ...
    var inputs = document.querySelectorAll('input[name=white-ips],input[name=white-hosts],input[name=white-isps]');
    ...
    $('#white-browsers,#white-os,#white-devices').multiselect({
